...
const PUBMOD_URL: &str = "https://www.ebi.ac.uk/europepmc/webservices/rest/search?format=json&pageSize=5&query={query}";
...
pub async fn fetch_metadata<I: HttpInfra>(
    ...
    let url = PUBMOD_URL.replace("{query}", blueprint.query.as_str());
